...
export class Color {
  ...
  unsubscribe(callback) {
    this.subscriptions.filter((cb) => cb !== callback);
  }
...
// this is janky - it just primes the class so that there's a valid color in it. It's
// more or less immediately overwritten. Should probably find a better solution.
color.set('rgb', { red: 1, green: 0, blue: 0 });
